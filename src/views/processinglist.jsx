...
const processinglist = () => {
  ...
  const handleSubmit = async () => {
    if (!loc_id || !date_time || !sand || !aggregate || !soil) {
      ...
      <CModal
        ...
        <CModalBody>
          ...
          <CCol md={6}>
            ...
            placeholder="Sand" onKeyPress={isNumberKey} className='mb-3'  onChange={(e) => setsand(e.target.value)} />

            <CFormLabel className="col-sm-2 col-form-label">
             Aggregate
             </CFormLabel>
            <CFormInput type="text" size="sm" onKeyPress={isNumberKey} placeholder="Aggregate" className='mb-3'  onChange={(e) => setaggregate(e.target.value)} />

            <CFormLabel className="col-sm-2 col-form-label">
              Soil
             </CFormLabel>
            <CFormInput type="text" size="sm" onKeyPress={isNumberKey} placeholder="Soil"  className='mb-3'  onChange={(e) => setsoil(e.target.value)}/>

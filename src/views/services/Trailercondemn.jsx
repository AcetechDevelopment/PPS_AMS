...
const Trailercondemn = () => {
  ...
  const columns = useMemo(
    () => [
      ...
      { Header: 'Trailer No', accessor: 'id', disableSortBy: true, },
      { Header: 'Type of Fault', accessor: 'vehicle_number' },
      { Header: 'ServiceEngineer', accessor: 'type' },
      { Header: 'Reason for Condemnation', accessor: 'wheels_count' },
    ...
    <>
      ...
      >
        <CModalHeader className='bg-secondary'>
          <CModalTitle id="NewProcessing">Trailer condemnation</CModalTitle>
        </CModalHeader>
